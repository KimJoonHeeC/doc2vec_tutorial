...
def main(_):
    ...
    if FLAGS.data_path and FLAGS.voc_test:
        print("testing the vocabulary dict to use this data.", FLAGS.data_path)
        dialog.load_vocab(FLAGS.data_path)
        ...
        print("generating the vocabulary dict by this data.", FLAGS.data_path)
